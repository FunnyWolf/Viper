...
function sidebarGuide(): DefaultTheme.SidebarItem[] {
    return [
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                {text: '主机信息', link: 'host_information'},
                {text: '开放端口', link: 'host_ports'},
                {text: '已知漏洞', link: 'host_vulnerability'},
                {text: '删除主机', link: 'delete_host'},
                {text: '', link: ''},
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                {text: '运行信息', link: 'detail_information'},
                {text: '内网路由', link: 'internal_routing'},
                {text: '命令终端', link: 'meterpreter'},
                {text: '端口转发', link: 'port_forward'},
                {text: '文件管理', link: 'session_file_management'},
                {text: '权限信息', link: 'session_information'},
                {text: '传输协议', link: 'transport_protocol'},
                {text: '删除权限', link: 'kill_session'},
                {text: '', link: ''},
            ]
        },
        {
