...
function sidebarGuide(): DefaultTheme.SidebarItem[] {
    return [
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                {text: 'Host Information', link: 'host_information'},
                {text: 'Host Ports', link: 'host_ports'},
                {text: 'Host Vulnerabilities', link: 'host_vulnerability'},
                {text: 'Delete Host', link: 'delete_host'},
                {text: '', link: ''},
            ]
        },
        {
            ...
            collapsed: false,
            items: [
                {text: 'Runtime Information', link: 'detail_information'},
                {text: 'Internal Routing', link: 'internal_routing'},
                {text: 'Command Terminal', link: 'meterpreter'},
                {text: 'Port Forwarding', link: 'port_forward'},
                {text: 'File Management', link: 'session_file_management'},
                {text: 'Session Information', link: 'session_information'},
                {text: 'Transport Protocol', link: 'transport_protocol'},
                {text: 'Terminate Session', link: 'kill_session'},
                {text: '', link: ''},
            ]
        },
        {
            ...
            collapsed: false,
            items: [
                {text: 'Dashboard', link: 'host_and_session_list'},
                {text: 'Run Module', link: 'run_module'},
                {text: 'Realtime Output', link: 'realtime_output'},
                {text: 'Task List', link: 'task_list'},
                {text: 'Listeners & Payloads', link: 'handler_and_payload'},
                {text: 'Connection Filtering', link: 'handler_firewall'},
                {text: 'WebDelivery', link: 'web_delivery'},
                {text: 'Automation', link: 'auto_arrangement'},
                {text: 'Credential Management', link: 'credential_management'},
                {text: 'File Management', link: 'file_management'},
                {text: 'Internal Proxy', link: 'internal_proxy'},
                {text: 'MSFCONSOLE', link: 'msfconsole'},
                {text: 'Network Topology', link: 'network_topology'},
        ...
        },
        {
            ...
            items: [
                ...
                {text: 'General Settings', link: 'common_config'},
                {text: 'OPENAI API', link: 'openai_api'},
                {text: 'SMTP Setting', link: 'smtp_config'},
                {text: 'DingTalk Bot', link: 'dingding_bot'},
                {text: 'Server Chan Bot', link: 'server_bot'},
        ...
        },
        {
            ...
            items: [
                ...
                {text: 'Issues/Download Logs', link: 'issues'},
                {text: '', link: ''},
            ]
        }
    ]
