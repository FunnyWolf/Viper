...
- `OPENAI`支持输入自定义模型名称
- `OPENAI`未配置时错误提示更为友好
- `获取互联网出口IP`模块API为https://ipwho.is/
- `邮件生成/发送智能体` `平台操作智能体`提示词更新,引入CoT及Role Play
